...
const schema = z.object({ name: z.string().min(1), color: z.string().default('#3f7f8f'), emoji: z.string().optional(), type: z.string().default('generic') });
